...
const FeedbackCard = ({ content, name, title, img }) => (
  <div
    className="feedback-card my-5 mr-0
    flex max-w-[370px] flex-col justify-between
  ...
  >
    ...
    <div className="flex flex-row">
      ...
      <div className="ml-4 flex flex-col">
        ...
        <p className="font-poppins text-[16px] font-normal leading-[24px] text-white">
          {title}
        </p>
      </div>
    </div>
